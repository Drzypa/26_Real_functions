...
\usepackage{pmmeta}
\pmcanonicalname{ConvergentSeries}
\pmcreated{2013-03-22 12:24:51}
\pmmodified{2013-03-22 12:24:51}
\pmowner{yark}{2760}
\pmmodifier{yark}{2760}
\pmtitle{convergent series}
\pmrecord{12}{32311}
\pmprivacy{1}
\pmauthor{yark}{2760}
\pmtype{Definition}
...
\pmrelated{UncoditionalConvergence}
\pmrelated{WeierstrassMTest}
\pmrelated{DeterminingSeriesConvergence}
\pmdefines{absolute convergence}
\pmdefines{conditional convergence}
\pmdefines{absolutely convergent}
\pmdefines{conditionally convergent}
\pmdefines{converges absolutely}
\pmdefines{convergent}
\pmdefines{divergent}
\pmdefines{divergent series}
